...
def cadastrarMedico():
    ...
    :return: Função para cadastrar medicos
    '''
    nome = input('Nome do médico: ')
    especialidade = input(f'Olá Dr.{nome}, qual a sua especialidade? ')
    horarios = input('Quais os seus horários disponíveis? (separados por vírgula): ').split(',')
    medico = [nome, especialidade, horarios]
    medicos.append(medico)
    print(f'Doutor {nome} cadastrado com sucesso.')
